...
|---|---|---|---|---|
| <hostname> | <IP> | Ubuntu 24.04 (Dokploy) | OpenClaw — personal instance | <date> |
| <hostname> | <IP> | Ubuntu 24.04 (n8n) | All n8n workflow automations (primary) | <date> |
| <hostname> | <IP> | Ubuntu 24.04 | Hermes Agent — Discord gateway (Vilnius, LT) | <date> |
...
- **OpenClaw** → managed via Dokploy.
- **Hermes** → Discord gateway. Setup/config docs in `docs/hermes/`.
- **n8n** → workflow automations server.

## Hermes ops (on Hermes VPS)
...
- Deeper docs (Discord/Slack/WhatsApp setup, file structure, vision config): `docs/hermes/`.
