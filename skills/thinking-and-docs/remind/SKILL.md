---
name: remind
description: Rewrite the last response simpler and shorter in plain English, prefixed with a 2-4 sentence TLDR of the conversation so far. Manual-only, invoked as /remind.
...
But make this paragraph very clear & easy to understand, literally 2-4 sentences max. THE PARAGRAPH SHOULD BE VERY CONCISE.
